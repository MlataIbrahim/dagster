...
To do this, we'll use the :py:func:`@map_to_dagster_type <dagster.dagster_type>` decorator:
...
The :py:func:`@map_to_dagster_type <dagster.dagster_type>` decorator lets us specify custom type checks
like this.
